...
library GatewayFetcher {
    ...
    function push(
        ...
        return push(r, bytes(s));
    }
    function push(
        GatewayRequest memory r,
        GatewayRequest memory p
    ) internal pure returns (GatewayRequest memory) {
        return push(r, p.encode());
    }
    ...
    function setOutput(
        ...
        return r.push(i).addByte(OP_SET_OUTPUT);
    }
    ...
    function lte(
        ...
        return r.addByte(OP_GT).flip();
    }
    function gte(
        GatewayRequest memory r
    ) internal pure returns (GatewayRequest memory) {
        return r.addByte(OP_LT).flip();
    }
